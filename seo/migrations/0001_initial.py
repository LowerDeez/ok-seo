    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_ru', models.CharField(blank=True, max_length=255, null=True, verbose_name='Seo Title')),
                ('keywords', models.TextField(blank=True, verbose_name='Meta Keywords')),
                ('keywords_ru', models.TextField(blank=True, null=True, verbose_name='Meta Keywords')),
                ('description', models.TextField(blank=True, verbose_name='Meta Description')),
                ('description_ru', models.TextField(blank=True, null=True, verbose_name='Meta Description')),
                ('image', models.ImageField(blank=True, null=True, upload_to=image_upload_to, validators=[django.core.validators.FileExtensionValidator(['jpg', 'jpeg', 'png'])], verbose_name='Изображение')),
                ('image_ru', models.ImageField(blank=True, null=True, upload_to=image_upload_to, validators=[django.core.validators.FileExtensionValidator(['jpg', 'jpeg', 'png'])], verbose_name='Изображение')),
                ('alt', models.CharField(blank=True, max_length=255, verbose_name='Alt')),
                ('alt_ru', models.CharField(blank=True, max_length=255, null=True, verbose_name='Alt')),
            ...
            bases=(SeoTagsMixin, models.Model),
        ),
        migrations.CreateModel(
            name='ViewSeo',
            fields=[
